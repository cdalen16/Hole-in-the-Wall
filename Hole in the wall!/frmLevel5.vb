...
Public Class frmLevel5
    ...
    Private Sub btnNextLevel_Click(sender As Object, e As EventArgs) Handles btnLevelSelect.Click
        Me.Close()
        frmLevelSelect.Show()
    End Sub
    ...
    Private Sub Timer1_Tick_1(sender As Object, e As EventArgs) Handles timGoodSkel.Tick
        If GHead.X = 0 And GHead.Y = 0 Then
            ...
            btnLevelSelect.BackColor = Color.Red
        ...
        Else
            ...
            btnLevelSelect.BackColor = Color.Green
