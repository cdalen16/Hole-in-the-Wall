...
Public Class frmLevelSelect
    ...
    Private Sub btnOption1_Click(sender As Object, e As EventArgs) Handles btnLevel1.Click
    ...
    Private Sub btnOption2_Click(sender As Object, e As EventArgs) Handles btnLevel2.Click
    ...
    Private Sub btnOption3_Click(sender As Object, e As EventArgs) Handles btnLevel3.Click
